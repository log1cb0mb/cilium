...
func init() {
	...
	flags.StringSlice(operatorOption.IngressLBLabelPrefixes, operatorOption.IngressLBLabelsDefault, "Label prefixes for propagating from Ingress to the Load Balancer service")
